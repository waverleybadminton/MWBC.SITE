(() => {
  ...
  const zh = {
    ...
    "Long-term — weekly for 1 year": "长期——每周，持续 1 年",
    "Long-term bookings": "长期预订",
    "Sorted by soonest to end — extend the ones near the top before they run out.": "按最快结束排序——请优先延续靠前的预订。",
    "No long-term bookings yet.": "暂无长期预订。",
    "Extend +1 year": "延续 1 年",
    "Weeks left": "剩余周数",
    "Ends": "结束日期",
    "Day & time": "星期与时间",
    "Customer": "客户",
